...
import org.socionicasys.analyst.RawAData;
import org.socionicasys.analyst.StyledText;
...
public class LegacyHTMLImporter extends SwingWorker<ADocument, Void> {
	private static final Logger logger = LoggerFactory.getLogger(LegacyHTMLImporter.class);
	...
	public LegacyHTMLImporter(File sourceFile) {
